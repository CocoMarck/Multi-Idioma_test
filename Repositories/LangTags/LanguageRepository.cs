...
namespace Repositories.LangTags {
    public class LanguageRepository {
        ...
        public void Insert(string code, bool isActive){            
            ...
            _db.Execute(
                sql: "INSERT INTO languages (code, created_at, updated_at, deleted_at, is_active) VALUES (@p0, @p1, NULL, NULL, @p2);", commit: true,
                code, now, isActive ? 1 : 0
            );
        }
        ...
        public void Update(int languageId, string code, bool isActive )
        {
            ...
            _db.Execute(
                ...
                code, now, deletedAt, isActive ? 1 : 0, languageId
            );
        }
